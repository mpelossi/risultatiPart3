...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{figures/part3_q1a_run1.png}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{figures/part3_q1a_run2.png}
        \caption{Run~2 (\texttt{2026-05-10-02h34m13s}). Same layout as Run~1. Makespan = 235\,s, max p95 = 384.8\,$\mu$s, $0/21$ SLO violations.}
    \end{figure}
    \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{figures/part3_q1a_run3.png}
